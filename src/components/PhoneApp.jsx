...
const PhoneApp = () => {
  return (
    <div className="relative   mt-24 flex h-auto max-w-7xl items-center justify-center xl:col-span-4 xl:col-start-5">
      <div className=" absolute h-80 w-80 rounded-full bg-primary lg:h-[400px] lg:w-[400px]" />
      <div className="relative   h-auto w-56 lg:w-72 ">
        <img className="z-20 h-auto w-auto object-contain" src={iphone} alt="iphone" />
