...
const Hero = () => {
  return (
    <div className=" z-0  grid place-items-center  gap-12 lg:grid-cols-12 lg:gap-20 ">
      ...
      <div className="flex h-full flex-col items-center justify-center gap-8 sm:justify-end   lg:col-span-6 lg:col-start-1 lg:row-start-1    ">
        ...
        <p className="mb-8 text-center text-[20px] text-[#9E9DA2]  md:text-2xl lg:mb-14 lg:text-left lg:text-2xl lg:text-[20px]">
          ...
          Nature to sustain its beauty. So what are you waiting for ? Lets ride toמgether
        </p>
